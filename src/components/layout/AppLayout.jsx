    ...
    <div className="min-h-screen bg-zinc-950 text-white flex">
      <aside className="hidden md:flex flex-col w-64 border-r border-white/5 bg-zinc-950/95 backdrop-blur-xl h-screen fixed left-0 top-0 z-40">
        ...
        <div className="p-4 border-t border-white/5">
          <div className="flex items-center gap-3 px-4 py-3 mb-2 bg-zinc-900/50 rounded-xl">
      ...
      <main className="flex-1 md:ml-64 min-h-screen bg-zinc-950 overflow-x-hidden pt-16 md:pt-0 relative z-0">
        <Outlet />
      </main>
