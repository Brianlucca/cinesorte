    ...
    <div className="bg-zinc-900 p-1 rounded-xl border border-white/10 inline-flex w-full sm:w-auto shadow-inner overflow-x-auto no-scrollbar">
      {tabs.map((tab) => (
        <button
          ...
          className={`flex-1 sm:flex-none flex items-center justify-center gap-2 px-5 py-2.5 text-sm font-bold rounded-lg transition-all duration-200 whitespace-nowrap ${
            activeTab === tab.id
